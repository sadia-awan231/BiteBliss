	...
	function foodland_setup() {
		...
		*/
		...
		add_theme_support( 'editor-color-palette', array(
	       	array(
				'name' => esc_html__( 'Blue', 'foodland' ),
				'slug' => 'blue',
				'color' => '#2c7dfa',
	       	),
	       	array(
	           	'name' => esc_html__( 'Green', 'foodland' ),
	           	'slug' => 'green',
	           	'color' => '#7ed221',
	       	),
	       	array(
	           	'name' => esc_html__( 'Golden', 'foodland' ),
	           	'slug' => 'golden',
	           	'color' => '#ce9b23',
	       	),
	       	array(
	           	'name' => esc_html__( 'Black', 'foodland' ),
	           	'slug' => 'black',
	           	'color' => '#2f3633',
	       	),
	       	array(
	           	'name' => esc_html__( 'Grey', 'foodland' ),
	           	'slug' => 'grey',
	           	'color' => '#82868b',
	       	),
	   	));
		...
		add_theme_support( 'editor-font-sizes', array(
		   	array(
		       	'name' => esc_html__( 'small', 'foodland' ),
		       	'shortName' => esc_html__( 'S', 'foodland' ),
		       	'size' => 12,
		       	'slug' => 'small'
		   	),
		   	array(
		       	'name' => esc_html__( 'regular', 'foodland' ),
		       	'shortName' => esc_html__( 'M', 'foodland' ),
		       	'size' => 16,
		       	'slug' => 'regular'
		   	),
		   	array(
		       	'name' => esc_html__( 'larger', 'foodland' ),
		       	'shortName' => esc_html__( 'L', 'foodland' ),
		       	'size' => 36,
		       	'slug' => 'larger'
		   	),
		   	array(
		       	'name' => esc_html__( 'huge', 'foodland' ),
		       	'shortName' => esc_html__( 'XL', 'foodland' ),
		       	'size' => 48,
		       	'slug' => 'huge'
		   	)
		));
...
function foodland_scripts() {
	...
	wp_register_style( 'foodland-web-font', wptt_get_webfont_url( $web_fonts_stylesheet ), false, null );
	...
	// blocks
	wp_enqueue_style( 'foodland-blocks', get_template_directory_uri() . '/css/blocks.css' );
 ...
 *
 * @since Foodland 1.0.0
 */
function foodland_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'foodland-block-editor-style', get_theme_file_uri( '/css/editor-blocks.css' ) );
}
add_action( 'enqueue_block_editor_assets', 'foodland_block_editor_styles' );
		...
		if ( !empty( $footer_content ) || !empty( $social_media_icon  ) ) {
            ...
            if( !empty( $footer_content ) ){     
            	$foodland_footer_content .= '
             			<div class="clear"></div>
            			<div class="copyright">    
                      		<p>' . wp_kses_data( $footer_content ); 
                      		if ( function_exists( 'the_privacy_policy_link' ) ) {
						    $foodland_footer_content .= get_the_privacy_policy_link( ' | ' );
						}
                  		$foodland_footer_content .= '</p>
                    	</div><!-- .copyright -->';
            }
...
if ( ! function_exists( 'foodland_nova_archive_content_image' ) ) :
	...
	function foodland_nova_archive_content_image() {
		...
		?>
			<figure class="entry-thumbnail one-half">
	            <a rel="bookmark" href="#">
	            	<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/no-featured-image.png" width="570px" height="800px">
				</a>
	        </figure><!-- .entry-thumbnail-->
	    <?php 
		}
